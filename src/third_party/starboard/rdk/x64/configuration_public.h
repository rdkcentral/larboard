...
#ifndef THIRD_PARTY_STARBOARD_RDK_X64_CONFIGURATION_PUBLIC_H_
#define THIRD_PARTY_STARBOARD_RDK_X64_CONFIGURATION_PUBLIC_H_
...
#endif  // THIRD_PARTY_STARBOARD_RDK_X64_CONFIGURATION_PUBLIC_H_
